...
const progressPercentage = (current / goal) * 100;
  ...
  return (
   ...
   <div className="pr-10 rounded-lg ">
    <aside className="bg-green-100 text-white w-28 space-y-10 py-3 px-2  items-center border-r-2 border-green-700 ">
      <div className="mb-10 prl-10">
        <Link to='/'>
      ...
      <nav className="flex flex-col space-y-4">
        ...
        <a href="/institution" className="flex flex-col items-center space-y-2 text-white hover:text-green-300 focus:text-green-300" aria-label="Schedule">
    ...
    <input type="text" placeholder="Search" className="bg-teal-100 outline-none pl-2 text-teal-600" />
      ...
      <div className="col-span-4 bg-green-500 p-6 rounded-lg shadow text-white">
       ...
       {/* Ensure this container is wide enough */}
        ...
        <div className=" col-span-4 flex-none bg-blue-500 w-40 p-4  shadow-lg text-white">
        <Card
          icon={<FaFire />}
          title="Energy Burn"
          metric="120 cal"
        ...
        /></div>
        <div className="col-span-4 flex-none bg-purple-500 w-40 p-4  shadow-lg text-white">
        <Card
          icon={<FaSwimmingPool />}
          title="Swimming"
          metric="01 hrs"
        ...
        <div className="col-span-4 flex-none bg-green-500 w-35 p-4 shadow-lg text-white">
        <Card
          icon={<FaHeartbeat />}
          title="Heart Rate"
          metric="75 BPM"
      ...
      <div className="pl-16"> 
      <aside className="w-72 h-100 bg-teal-100 p-6 flex flex-col bg-green-100 ">
